...
optimizer = "RRM + ADAM (0.1) + learned lookahead"
    ...
    for values in all_values:
        ...
        for step in range(steps+1):
            ...
            if step>0:
                ...
                #########################################
                print(f"{step}: diff - {theta_diff}, optimal diff - {optimal_diffs[-1]:.5f}, risk - {perf_risks[-1]:.5f}, T-loss - {first_loss:.5f} -> {T_loss:.5f}")
